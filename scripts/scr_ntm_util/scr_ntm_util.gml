...
///@arg {Real} yscale
///@arg {Real} rot
///@arg {Constant.Color} blend
///@arg {Real} alpha
function draw_pixel(_x, _y, _xscale, _yscale, _rot = 0, _blend = c_white, _alpha = 1)
{
	draw_sprite_ext(spr_pixel, 0, _x, _y, _xscale, _yscale, _rot, _blend, _alpha)
}